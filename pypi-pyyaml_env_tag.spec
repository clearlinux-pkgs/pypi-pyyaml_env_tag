...
Source0  : https://files.pythonhosted.org/packages/c2/95/32c8c79d784552ed687c676924381c0dc88b2a0248b50a32f4b5ac0ba03c/pyyaml_env_tag-1.0.tar.gz
...
%prep
%setup -q -n pyyaml_env_tag-1.0
cd %{_builddir}/pyyaml_env_tag-1.0
pushd ..
cp -a pyyaml_env_tag-1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747071523
...
cp %{_builddir}/pyyaml_env_tag-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pyyaml_env_tag/9740bf8b47654938076b40a0f533700e60230032 || :
