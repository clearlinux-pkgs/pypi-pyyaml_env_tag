...
Source0  : https://files.pythonhosted.org/packages/eb/2e/79c822141bfd05a853236b504869ebc6b70159afc570e1d5a20641782eaa/pyyaml_env_tag-1.1.tar.gz
...
%prep
%setup -q -n pyyaml_env_tag-1.1
cd %{_builddir}/pyyaml_env_tag-1.1
pushd ..
cp -a pyyaml_env_tag-1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747234034
